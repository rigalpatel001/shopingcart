...
router.get('/delete-image/:image' ,async (req,res) => {
    ...
    const image = 'public/product_images/' + req.query.id + '/gallery/' + req.params.image;
    const thumbnail = 'public/product_images/' + req.query.id + '/gallery/thumbs/' + req.params.image; 
     
    fs.remove(image, function (err) {
        if (err) {
            console.log(err);
        } else {
            fs.remove(thumbnail, function (err) {
                if (err) {
                    console.log(err);
                } else {
